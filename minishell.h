...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/29 14:09:45 by olachgue          #+#    #+#             */
/*   Updated: 2025/06/29 14:47:07 by olachgue         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					here_doc(char *limiter, int *fd, int *expnd_flg, \
					t_glob_st *glob_strct);
char				*ft_itoa(int n);
void				update_node_value(t_env *node, char *value, \
						int append, int have_equal);
...
int					handle_dotdot_logic(char *path, char *old_pwd, \
						char **logical_pwd);
...
int					handle_invalid_with_multiple_args(char **s_cmd, \
						int is_valid);
...
int					handle_new_node(t_env **env, char *key, \
						char *value, int have_equal);
